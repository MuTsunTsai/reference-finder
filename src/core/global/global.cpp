...
std::array<int, 7> Shared::sAxioms = {2, 3, 7, 6, 5, 4, 1};

// The score weight for each axiom
std::array<int, 7> Shared::sAxiomWeights = {0, 0, 0, 0, 0, 0, 0};
...
key_t Shared::sNumX = 5000;
key_t Shared::sNumY = 5000;
key_t Shared::sNumA = 5000;
key_t Shared::sNumD = 5000;
...
std::vector<XYPt> Shared::existingMarks;
std::vector<XYLine> Shared::existingLines;
