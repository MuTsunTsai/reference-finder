									...
									<div className="row gx-3 align-items-center">
										{store.statisticsRunning ? (<>
											...
											<div className="col col-auto">
												<button className="btn btn-secondary capitalize" type="button" onClick={cancel} disabled={canceling}>
													{t("keyword.cancel")}&nbsp;<i className="fa-solid fa-spinner fa-spin"></i>
												</button>
											</div>
										</>) : (<>
											<div className="col">
												<IntInput value={settings.trials} min={1} onInput={v => useSettings.setState({ trials: v })} />
											</div>
											<div className="col col-auto">
